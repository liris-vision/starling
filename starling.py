...
#		#self.bgpb = GdkPixbuf.Pixbuf.new_from_file('base.png')
#		ctx.save()
...
def main(argv):
	...
	#TODO-fix if not batchMode:
	#TODO-fix 	m = splashScreen()
	#TODO-fix 	m.setup()
	#TODO-fix 	m.show_window()
	#TODO-fix 	sleep ( 2 )
	...
	if not batchMode:
		#TODO-fix  m.window.set_transient_for(HarpiaFrontend.gtkTopWindow)
		HarpiaFrontend.show( center=0 )
		sleep ( 1 )
		#TODO-fix  m.window.destroy ()
